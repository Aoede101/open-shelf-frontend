...
export default function DiscussionRoomPage() {
  ...
  const handleSendMessage = async (e) => {
    ...
    setSending(true);
    try {
      const updatedDiscussion = await discussionService.sendMessage(id, message);
  ...
  const isParticipant = discussion.participants?.some(p => p._id === user?.id);
          ...
          {isAuthenticated ? (
            isParticipant ? (
              ...
              <div className="text-center">
                <p className="text-gray-600 mb-3">Join the discussion to send messages</p>
                <button
